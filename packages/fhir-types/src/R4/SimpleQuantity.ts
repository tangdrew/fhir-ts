...
export interface SimpleQuantityOutputType {
  /** Unique id for inter-element referencing */
...
export const SimpleQuantity: t.RecursiveType<
  t.Type<SimpleQuantity, SimpleQuantityOutputType>,
  SimpleQuantity,
  SimpleQuantityOutputType
> = t.recursion<SimpleQuantity, SimpleQuantityOutputType>(
  "SimpleQuantity",
  () =>
    t.intersection(
      [
