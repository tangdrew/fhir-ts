...
export interface DurationOutputType {
  /** Unique id for inter-element referencing */
...
export const Duration: t.RecursiveType<
  t.Type<Duration, DurationOutputType>,
  Duration,
  DurationOutputType
> = t.recursion<Duration, DurationOutputType>("Duration", () =>
  t.intersection(
    [
      t.type({}),
      t.partial({
